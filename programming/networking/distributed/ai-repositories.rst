...
AI Servers are, clients that reside on a server rather then on the end users
client machines. An AI Server or usually called AI Repository is used to create
