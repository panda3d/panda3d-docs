...
.. only:: python
   ...
   .. code-block:: bat
      ...
      cd C:\Panda3D-1.10.6-x64\mystuff\

   Instead of version 1.10.6-x64, you should type the version number of Panda3D
...
.. only:: cpp
   ...
   ::
      ...
      C:\Panda3D-1.10.6-x64\include

   .. rubric:: Library Directories

   ::

      C:\Panda3D-1.10.6-x64\lib
   ...
   ::
      ...
      PATH=C:\Panda3D-1.10.6-x64\bin;%PATH%
