...
.. only:: python
    ...
    just use DirectStart to open a window and skip this page.
...
.. only:: cpp
    ...
    Second, we need to
    create an instance of the PandaFramework class, and use it to open a window.
    ...
    keyboard support to receive mouse button events, since it sets up the button
    event handlers.
    ...
    The WindowFramework class also provides all the basic things the python
    ShowBase / DirectStart equivalent would normally take care of:
