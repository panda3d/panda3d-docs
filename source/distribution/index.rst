...
:ref:`the old distribution method <using-the-legacy-distribution-method>`, which
was more complex to use and maintain, required special builds of Panda3D, and
did not work with Python 3.
